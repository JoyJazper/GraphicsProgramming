...
void Game::UpdateModel()
{
	...
	cout << "x = " << x_mobile << "y = " << y_mobile << endl;
	...
	const int left_fixed = x_fixed - 20;
	const int right_fixed = x_fixed + 20;
	const int top_fixed = y_fixed - 20;
	const int bottom_fixed = y_fixed + 20;
